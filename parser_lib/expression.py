...
class exp_parser():
    def __init__(self, _exp_input_list):
        ...
        self.prefix_parse_fns[token.QUERY] = self.parse_query
    ...
    def parse_query(self):
        return QueryNode(self.curr_token, self.curr_token.literal)
